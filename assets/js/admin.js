(function ($) {
  ...
  function renderPrettyReport(r) {
    ...
    if (r.summary && typeof r.summary === "object") {
      if (typeof r.summary.passed !== "undefined" && r.summary.passed !== null) {
        passed = r.summary.passed;
      }
      if (typeof r.summary.total !== "undefined" && r.summary.total !== null) {
    ...
    var headHtml =
      ...
      '<div><strong>Passed:</strong> ' + escapeHtml(passed) + " / " + escapeHtml(total) + "</div>" +
  ...
  function openReportPrintWindow(report) {
    ...
    if (report.summary && typeof report.summary === "object") {
      if (typeof report.summary.passed !== "undefined" && report.summary.passed !== null) {
        passedText = report.summary.passed;
      }
      if (typeof report.summary.total !== "undefined" && report.summary.total !== null) {
        totalText = report.summary.total;
      }
    }
...
<body>
  ...
  <div class="meta">
    ...
    <div><strong>Passed:</strong> ${escapeHtml(passedText)} / ${escapeHtml(totalText)}</div>
  ...
  function setSoc2Bundle(bundle) {
    ...
    if (enabledFlag === false) {
      ...
      var statusParts = [];
      if (generated) {
        statusParts.push("Last generated on " + generated);
      } else {
        statusParts.push("Report cached");
      }
      statusParts.push("covering " + trustText + ".");
      var endpoint = meta && meta.source_endpoint ? String(meta.source_endpoint) : "";
      if (endpoint) {
        statusParts.push("Endpoint: " + endpoint);
      }
      setSoc2StatusText(statusParts.join(" "), false);
    } else {
